function op=ni2019_outgoing_eigen_operator_complex(cfg,k0,kBloch)
%NI2019_OUTGOING_EIGEN_OPERATOR_COMPLEX Complex-frequency outgoing operator.
%   This is the all-channel counterpart of
%   ni2019_full_eigen_operator_complex.  Every exterior Floquet harmonic is
%   analytically continued from the physical real-frequency sheet: open
%   channels have positive real ky and closed channels have negative
%   imaginary ky for the exp(+i*omega*t) convention used by the solver.
...
op=struct('F',F,'Fscaled',Fscaled,'orders',orders,'kx',kx,'ky',ky, ...
    'k0',k0,'kBloch',kBloch,'cos_depth_normalized',cosDepth, ...
    'beta_sin_normalized',betaSin,'vertical_scale',verticalScale, ...
    'log_vertical_scale',logVerticalScale,'beta',betaList, ...
